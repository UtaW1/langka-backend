defmodule LangkaOrderManagementWeb.ExportTransaction do
  ...
  def perform(conn, args) do
    ...
    directory = "/transaction/transaction-report-#{timestamp}.xlsx"
    ...
    case Supabase.get_download_url(%{file_path: directory, bucket_name: bucket_name}) do
      ...
      {:error, "404"} ->
        Report.list_transactions_for_export(args)
        |> Report.construct_xlsx_for_export("Transaction Report", args)
